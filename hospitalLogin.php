    ...
    <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <div class="p-6 bg-red-100 rounded-lg">
            ...
            <form action="hospitalLogin.php" method="POST">
                ...
                <input class="w-full p-2 text-white bg-red-600 rounded-md shadow-sm cursor-pointer hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" 
